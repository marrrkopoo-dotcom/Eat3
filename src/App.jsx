            ...
            <div className="container mx-auto px-4 py-3 flex items-center justify-between">
                <div className="flex items-center gap-6">
                    <div className="flex items-center group cursor-pointer" onClick={() => navigateTo('shop', 'Всі')}>
                        <img src="images/logo.svg?v=3" alt="жуйка" className="h-10 w-auto object-contain block select-none" />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                        <div>
                            <div className="mb-4 flex items-center select-none">
                                <img src="images/logo.svg?v=3" alt="жуйка" className="h-8 w-auto object-contain block" />
                            </div>
